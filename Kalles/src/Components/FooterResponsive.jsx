...
export const FooterResponsive = () => {
    ...
    return (
        <div className=' mb-18'>
            <div className='footer-responsive flex flex-col gap-5 px-10 py-15 bg-[#f6f6f8]'>
                <div onClick={() => setgetintouch(!getintouch)} className='flex justify-between'>
                    <span className='medium'>Get In Touch</span>
                    <i className={`${getintouch ? 'bi bi-dash-lg' : 'bi bi-plus-lg'}`}></i>
                </div>
                {
                    getintouch && <div className="column-1  flex  flex-col gap-4">
                ...
                <div onClick={() => setcategories(!categories)} className='flex justify-between'>
                    <span className='medium'>Categories</span>
                    <i className={`${categories ? 'bi bi-dash-lg' : 'bi bi-plus-lg'}`}></i>
                </div>
                {
                    categories && <div className="column-2 w-fit flex flex-col gap-4">
                ...
                <div onClick={() => setinformation(!information)} className='flex justify-between'>
                    <span className='medium'>Information</span>
                    <i className={`${information ? 'bi bi-dash-lg' : 'bi bi-plus-lg'}`}></i>
                </div>
                {
                    information && <div className="column-3  w-fit flex flex-col gap-4">
                ...
                <div onClick={() => setuseful(!useful)} className='flex justify-between'>
                    <span className='medium'>Useful links</span>
                    <i className={`${useful ? 'bi bi-dash-lg' : 'bi bi-plus-lg'}`}></i>
                </div>
                {
                    useful && <div className="column-4 w-fit flex flex-col gap-4">
                        <div className='flex flex-col whitespace-nowrap gap-2 text-[#878787] '>
                ...
                <div onClick={() => setnewsletter(!newsletter)} className='flex justify-between'>
                    <span className='medium'>Newsletter Signup</span>
                    <i className={`${newsletter ? 'bi bi-dash-lg' : 'bi bi-plus-lg'}`}></i>
                </div>
                {
                    newsletter && <div className="column-5 flex-col gap-4">
                        <div className='flex flex-col gap-2 text-[#878787] '>
            ...
            <div className='bg-[#fff] text-[#878787] text-sm text-center flex-col items-center justify-between py-5'>
                <span>
                    All Rights Reserved ©&nbsp;
