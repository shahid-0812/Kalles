    ...
    return (
        <div className='terms-and-condition-container'>
            <div
                ...
                <h1 className=' z-10 text-xl medium'>Terms & Conditions</h1>
            ...
            <div className="flex flex-col gap-5 terms px-10 py-15">
                ...
                <div className='flex flex-col gap-2'>
                    <span className='font-bold'>Products, Content and Specifications</span>
                    <span className="text-sm">
                ...
                <div className='flex flex-col gap-2'>
                    <span className='font-bold'>Shipping Limitations</span>
                    <span className="text-sm">
                ...
                <div className='flex flex-col gap-2'>
                    <span className='font-bold'>Duties and Taxes</span>
                    <span className="text-sm">
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <span className="text-sm">By placing an order, you warrant that you are over 18 years of age, and that you are providing shop.company.com or shop.beetle.com.sg with accurate, truthful information and that you have the authority to place the order.</span>
                </div>
                <div className='flex flex-col gap-2'>
                    <span className='font-bold'>Exchange and Refund Policy (Singapore Outlets Only)</span>
                    <span className="text-sm">
                ...
                <div className='flex flex-col gap-2'>
                    <span className='font-bold'>Exchange and Refund Policy (Online Shop)</span>
                    <span className="text-sm">Electronic Communications</span>
                    <span className="text-sm">When you visit this website and/or send email to us, you consent to receive electronic communications from us. You agree that all agreements, notices, disclosures and other communications that we sent you electronically satisfy any legal requirement that such communications be in writing
                    </span>
                    <span className="text-sm">
